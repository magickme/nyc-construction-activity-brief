...
function sampleRequestScript() {
  return `<script>
      ...
      document.addEventListener('click', (event) => {
        const link = event.target.closest('[data-topic-request-path]');
        if (!link) return;
        const url = new URL(link.href, window.location.href);
        trackSampleRequestEvent('topic_request_path_clicked', {
          source: new URLSearchParams(url.search).get('source') || '',
...
function segmentHubTrackingScript() {
  return `<script>
      ...
      document.addEventListener('click', (event) => {
        ...
        const buyerPath = event.target.closest('[data-segment-hub-buyer-path]');
        if (buyerPath) {
          trackSegmentHubEvent('segment_hub_buyer_path_clicked', {
            source: 'segment-hub-buyer-paths',
            destination: segmentHubDestination(buyerPath),
          });
        }
      });
    </script>`;
...
function shareKitTrackingScript() {
  return `<script>
      function trackShareKitEvent(name, data) {
        try {
          window.va = window.va || function () { (window.vaq = window.vaq || []).push(arguments); };
          window.va('event', { name, data });
        } catch (error) {}
      }
      function shareKitDestination(link) {
        const href = link.getAttribute('href') || '';
        return href.split('?')[0].replace(/^https:\\/\\/nycpermitbrief\\.com\\//, '').replace(/^\\//, '').replace(/\\.html$/, '') || 'home';
      }
      document.addEventListener('click', (event) => {
        const link = event.target.closest('[data-share-kit-path]');
        if (!link) return;
        trackShareKitEvent('share_kit_path_clicked', {
          source: 'share-kit',
          destination: shareKitDestination(link),
          path_type: link.dataset.shareKitPath || 'unknown',
        });
      });
    </script>`;
}
    ...
    <main>
      <section class="section card">
        ...
        <section class="section" data-checkout-source-fit="buy-page-source-sidewalk-shed" hidden>
          ...
          <p>This checkout path is for the 23 selected sidewalk shed rows in the current ZIP. The same download also includes the full 118-row issue and buyer workbook.</p>
        </section>
        <section class="section" data-checkout-source-fit="buy-page-source-plumbing" hidden>
          <h2>Plumbing checkout check</h2>
          <p>This checkout path is for the 23 selected plumbing rows in the current ZIP. The same download also includes the full 118-row issue and buyer workbook.</p>
        </section>
        <section class="section" data-checkout-source-fit="buy-page-source-exterior-access" hidden>
          ...
          <p>This checkout path is for the 61 selected exterior-access rows across sidewalk shed, supported scaffold, construction fence, and structural activity. The same download also includes the full 118-row issue.</p>
        </section>
...
${sampleStats(page)}${sampleTable(page)}      <section class="section card">
        ...
        <p>
          <a data-topic-request-path class="button secondary" href="/invoice-request.html?source=${requestPathSource}">Invoice or procurement request</a>
          <a data-topic-request-path class="button secondary" href="/team-license.html?source=${requestPathSource}">Team or multi-issue access</a>
          <a data-topic-request-path class="button secondary" href="/custom-research.html?source=${requestPathSource}">Custom research request</a>
          <a data-topic-request-path class="button secondary" href="/partner-inquiry.html?source=${requestPathSource}">Partner inquiry</a>
          <a data-topic-request-path class="button secondary" href="/sample-request.html?source=${requestPathSource}">Different sample cut</a>
        </p>
...
${socialImageMeta()}
  ...
  <body>
    <main>
      ...
      <p class="lede">These pages are generated from the 118-row paid issue. The free CSV preview is limited to 25 rows. Each page keeps counts, source links, buyer use cases, and claims boundaries visible.</p>

      <section class="section card">
        <h2>Get the current issue</h2>
        <p>The paid ZIP includes the CSV, Markdown brief, source registry, buyer README, QA report, version file, and claims boundary for the 2026-06-26 to 2026-07-02 issue. Current launch price is $9.50.</p>
...
function boroughPermitsHtml(rows, config) {
  const matchingRows = rows.filter((row) => row.borough.toLowerCase() === config.borough.toLowerCase());
...
${sampleRequestSection({
    ...
    territory: 'NYC',
      ...
      <section class="section card">
        ...
        <a class="button secondary" href="/real-estate-investor-permit-research.html">Real estate investor permit research</a>
        <a class="button secondary" href="/topics/nyc-construction-permit-data-for-insurance.html">Insurance permit data topic</a>
        <a class="button secondary" href="/nyc-permit-activity-by-zip.html">Permit activity by ZIP</a>
        <a class="button secondary" href="/inside-the-zip.html">See ZIP contents</a>
        <a class="button secondary" href="/csv-field-guide.html">CSV field guide</a>
        <a class="button secondary" href="/time-saved-calculator.html">Time saved calculator</a>
...
${socialImageMeta()}
  ...
  <body class="has-conversion-bar">
    <main>
      ...
      <p>
        <a class="button" data-share-kit-path="buy" href="${productUrl}">Buy current ZIP</a>
        <a class="button secondary" data-share-kit-path="preview" href="/preview.html">Open public preview</a>
        <a class="button secondary" data-share-kit-path="dataset" href="/dataset-catalog.html">Dataset catalog</a>
        <a class="button secondary" data-share-kit-path="sample-request" href="/sample-request.html?source=share-kit">Request a sample cut</a>
      </p>
      ...
      <section class="section card">
        ...
        <p><a class="button secondary" data-share-kit-path="current-issue" href="/current-issue.html">Current issue page</a> <a class="button secondary" data-share-kit-path="comparison" href="/free-vs-paid.html">Free vs paid</a></p>
      </section>
      ...
      <section class="section">
        ...
        <div class="grid">
          <div class="card">
            <h3>Construction pipeline newsletters</h3>
            <p>Use the current issue page when the audience already tracks new development, construction pipeline, or permit activity. Keep the ask to a resource mention or placement inquiry.</p>
          ...
          <div class="card">
            <h3>Supplier and service groups</h3>
            <p>Use the supplier topic when the audience sells materials, equipment, maintenance, or local B2B services. Do not imply the ZIP includes buyer contact data.</p>
            <p><a class="button secondary" data-share-kit-path="supplier-groups" href="${baseUrl}/topics/nyc-construction-permit-data-for-suppliers.html?source=share-kit-supplier-groups">Supplier group link</a></p>
          </div>
          <div class="card">
            <h3>Real estate communities</h3>
            <p>Use the free preview for brokers, investors, developers, and consultants who want to inspect the row shape before checkout.</p>
            <p><a class="button secondary" data-share-kit-path="real-estate-community" href="${baseUrl}/preview.html?source=share-kit-real-estate-community">Real estate community link</a></p>
          </div>
        </div>
      </section>
    ...
    <aside class="conversion-bar" data-conversion-bar>
      ...
      <div class="conversion-actions">
        <a class="button secondary" data-share-kit-path="sticky-preview" href="/preview.html">Preview</a>
        <a class="button" data-share-kit-path="sticky-checkout" href="${baseUrl}/checkout.html?source=share-kit">Buy ZIP</a>
      </div>
    </aside>
    ${shareKitTrackingScript()}
  </body>
</html>
`;
}
...
function teamLicenseHtml(rows) {
  const range = sampleRange(rows);
  const description = 'Request team, multi-issue, or recurring access for the NYC Weekly Construction Activity Brief without changing the current one-time checkout path.';
  const pageUrl = `${baseUrl}/team-license.html`;
  const webPage = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    name: 'NYC Construction Brief team license request',
    description,
    url: pageUrl,
    isPartOf: {
      '@type': 'WebSite',
  ...
  const faq = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Can a team request multi-issue access?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes. Use the request form to describe the team size, issue cadence, territory, and procurement needs. The current public checkout remains a one-time current-issue ZIP purchase.',
        },
      },
      {
        '@type': 'Question',
        name: 'Does this create a subscription?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'No. The form records interest only. Any subscription, recurring delivery, custom license, or payment term still needs separate approval and setup.',
        },
      },
      {
        '@type': 'Question',
        name: 'What should a team review first?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Review the current issue page, public CSV preview, inside-the-ZIP page, pricing page, and support boundary before requesting team access.',
        },
      },
    ],
  };
  const breadcrumb = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'NYC Construction Activity Brief', item: `${baseUrl}/` },
      { '@type': 'ListItem', position: 2, name: 'Team license request', item: pageUrl },
    ],
  };
  return `<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Team License Request | NYC Construction Activity Brief</title>
    <meta name="description" content="${description}">
    <link rel="canonical" href="${pageUrl}">
${alternateDiscoveryLinks()}
    <meta property="og:type" content="website">
    <meta property="og:title" content="Team License Request | NYC Construction Activity Brief">
    <meta property="og:description" content="${description}">
    <meta property="og:url" content="${pageUrl}">
${socialImageMeta()}
    <link rel="stylesheet" href="/styles.css">
  ...
  <body>
    <main>
      <nav><a href="/">NYC Construction Activity Brief</a></nav>
      <h1>Request team or multi-issue access.</h1>
      <p class="lede">Use this page when one current ZIP is useful, but your team needs repeated issues, shared access, procurement review, or a custom purchase path.</p>
      <p>
        <a class="button" href="#sample-request">Send team request</a>
        <a class="button secondary" href="${checkoutHref('team-license')}">Buy current ZIP</a>
        <a class="button secondary" href="/inside-the-zip.html">Inside the ZIP</a>
        <a class="button secondary" href="/pricing.html">Pricing</a>
      </p>
      <p class="fine">This request does not create a subscription, recurring delivery, custom license, payment term, or manual fulfillment commitment.</p>

      <section class="grid">
        <div class="card">
          <h2>Current issue proof</h2>
          <p>${escapeHtml(rows.length)} paid issue rows, 25 free preview rows, issued dates ${escapeHtml(range.firstIssuedDate)} to ${escapeHtml(range.latestIssuedDate)}, source dataset rbx6-tga4.</p>
        </div>
        <div class="card">
          <h2>Use this if</h2>
          <p>Your team wants repeated weekly review, several users, procurement approval, or a custom bundle of future public-record issues.</p>
        </div>
        <div class="card">
          <h2>Boundary</h2>
          <p>No private contacts, guaranteed leads, audience guarantees, buyer outcomes, automatic renewal, or approved payment terms.</p>
        </div>
      </section>
      ...
      <section class="section card">
        ...
        <ul>
          <li>Team size and buyer type.</li>
          <li>Territory, work types, and issue cadence needed.</li>
          <li>Whether you need invoice, purchase order, or procurement approval.</li>
          <li>Whether you need one issue, multiple future issues, or a recurring review packet.</li>
        </ul>
      </section>

${sampleRequestSection({
        heading: 'Send team license request',
        intro: 'Use this form for team, multi-issue, recurring-access, or procurement-review interest. Include team size, issue cadence, territory, work types, and approval needs.',
        workType: 'Team license or multi-issue access',
        territory: 'NYC',
        buyerType: 'data-buyer',
        monitoringGoal: 'Team license request for multiple users and recurring multi-issue access.',
        consentCopy: 'You may reply about this team license request.',
        buttonCopy: 'Send team request',
        statusCopy: 'This does not join the MagickMe newsletter. No subscription, recurring delivery, or custom payment term is created from this form alone.',
        fallbackSubject: 'NYC Construction Brief team license request',
        fallbackSourceLabel: 'Team license request source',
        successCopy: 'Team license request saved. I will use this to evaluate higher-value buyer demand.',
        failedCopy: 'Team license request was not saved.',
        emailFallbackLabel: 'Email this team request',
        eventPrefix: 'team_license_request',
        currentIssueCta: false,
      })}
...
function buildGeneratedPages(rows) {
  ...
  for (const [zipCode, count] of [...countBy(rows, (row) => row.zip_code).entries()].filter(([zip]) => zip).sort((a, b) => b[1] - a[1] || a[0].localeCompare(b[0]))) {
    ...
    pages.push({
      ...
      currentSample: `ZIP ${zipCode} has ${count} rows in the 2026-06-26 to 2026-07-02 paid issue.`,
  ...
  for (const [key, count] of [...countBy(rows, (row) => `${row.borough}|${row.work_type}`).entries()].filter(([, count]) => count >= 3).sort((a, b) => b[1] - a[1] || a[0].localeCompare(b[0]))) {
    ...
    pages.push({
      ...
      currentSample: `${boroughName} ${work.lowerLabel} has ${count} rows in the 2026-06-26 to 2026-07-02 paid issue.`,
  ...
  for (const [key, count] of [...countBy(rows, (row) => `${row.zip_code}|${row.work_type}`).entries()].filter(([, count]) => count >= 3).sort((a, b) => b[1] - a[1] || a[0].localeCompare(b[0]))) {
    ...
    pages.push({
      ...
      currentSample: `${work.label} in ZIP ${zipCode} has ${count} rows in the 2026-06-26 to 2026-07-02 paid issue.`,
  ...
  for (const [workType, count] of [...countBy(rows, (row) => row.work_type).entries()].filter(([type]) => type).sort((a, b) => b[1] - a[1] || a[0].localeCompare(b[0]))) {
    ...
    pages.push({
      ...
      currentSample: `${work.label} has ${count} rows in the current 118-row paid issue. The free CSV preview is limited to 25 rows.`,
