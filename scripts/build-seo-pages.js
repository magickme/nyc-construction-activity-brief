    ...
    <main>
      <section class="section card">
        ...
        <section class="section" data-current-best-fit>
          ...
          <p>The current issue is strongest for sidewalk shed and exterior-access screening: 40 sidewalk shed rows, 13 supported scaffold rows, 9 construction fence rows, and 12 structural rows.</p>
          <p>
            <a class="button secondary" href="/nyc-sidewalk-shed-permits.html">Check sidewalk shed fit</a>
        ...
        <section class="section" data-first-use-plan>
          ...
          <ul>
            <li>Filter the priority-slices CSV to sidewalk shed, supported scaffold, construction fence, or structural rows.</li>
